...
I design and build reliable business automation systems using **n8n, Make, APIs and AI** — turning repetitive processes into structured, maintainable workflows.

📍 Gdańsk, Poland · **Open to 100% Remote — EU / Worldwide**
...
**Integration**  
`REST APIs` · `Webhooks` · `JSON` · `OAuth/API Authentication`

**AI**  
`AI/LLM Workflows` · `Structured Extraction` · `Classification` · `Human-in-the-loop`

**Business Systems**  
`CRM` · `Google Workspace` · `Email` · `Calendar` · `Google Sheets`

**Workflow Engineering**  
`JavaScript` · `Validation` · `Deduplication` · `Idempotency` · `Error Handling` · `Retries` · `Logging`

---

## How I Build

**Understand → Design → Build → Test → Break → Recover → Document → Handover**

I focus not only on the happy path, but also on what happens when data is incomplete, a request is duplicated, an API fails, a rate limit is reached, or human review is required.
...
Critical business logic should be predictable, testable and explainable.

### AI where it adds value

LLMs are useful for classification, extraction and summarization. Deterministic rules remain preferable where business decisions require predictable behavior.

### Human-in-the-loop when needed

Automation should know when not to make the final decision.

### Provider-independent architecture

Integrations should be replaceable without rebuilding the entire business process.

### No secrets in repositories

Public implementations use synthetic data, mock credentials and `.env.example` files.
...
I am interested in **100% remote** roles involving:

**AI Automation · Workflow Automation · AI Implementation · Systems Integration · Business Process Automation · Technical Operations**

Particularly where the work involves translating real business processes into reliable systems using **n8n, Make, APIs and AI**.
